...
<script type="text/javascript">
	...
	function addAddr(){
		...
		window.location.href="AddShipaddressServlet?name="+addr_name+"&address="+addr_detail+"&telephone="+addr_phone+"&customerId="+64;
	}//end  确认新增收货地址
...
/* 		document.getElementById('addAdd').value
	...
	function confirmOrder() {
		window.location.href="SaveOrderServlet";
	}
...
<body>
    ...
    <div class="content">
    	<div class="contentCenter">
    		<b style="font-size:20px;">常用收货人：</b>
    		<br><br>
    		<p style="font-size:15px;color:red">
    			<input type="radio" name="address" checked="checked" onclick="addShipaddress(${customer.id},'${customer.username}','${customer.address}','${customer.phone}')">
	    		${customer.username }
	    		${customer.address }
	    		${customer.phone }
	    		(默认)
				...
				<input type="radio" name="address" onclick="addShipaddress(51,'张三','山西省太原市尖草坪区中北大学','18811012136')">
				...
				<p style="font-size:15px;">
				<input type="radio" name="address" onclick="addShipaddress(52,'张三','江西省南昌市青山湖区','18811012136')">
				...
				<p style="font-size:15px;">
				<input type="radio" name="address" onclick="addShipaddress(48,'李四','北京市北京市东城区东四十条','18811012131')">
				...
				<p style="font-size:15px;">
				<input type="radio" name="address" onclick="addShipaddress(49,'李四','江苏省苏州市昆山市巴城镇学院路828号','18811012121')">
				...
				<p style="font-size:15px;">
				<input type="radio" name="address" onclick="addShipaddress(50,'张三','江苏省南京市秦淮区','18811012136')">
    		...
    		<div class="centerTop">
    			<b style="font-size:20px;">收货人信息</b>
		    		 	...
		    		 	<p style="font-size:15px;">
							收件人姓名：<input type="text" id='addName' value="${customer.username }" disabled  name="name"><br/><br/>
							收件人地址：<input type="text" id='addAdd' value="${customer.address }" disabled  name="address" ><br/><br/>
							收件人电话：<input type="text" id='addPhone' value="${customer.phone }" disabled  name="tel" >
						</p>
    			...
    			<c:forEach items="${order.lines }" var="line">
    				<div class="bigDiv">
    					<div class="twoDiv">
							...
							<ul class="oneUL">
		    					<li>
		    						<img src="images/book_shopCart/${line.book.image }" class="pic">
		    						<p>${line.book.category.name }&nbsp;&nbsp;${line.book.name }&nbsp;&nbsp;</p>
		    						<p>¥ <font class="price">${line.book.price }</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×<font class="num">${line.num }</font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货</p>
    		...
    		<div class="money">
    			<span>共<font>${booknum }</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font class="total">${totalnum }</font></span>
    			<span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥ 0.00</span>
    			
    			<!-- <span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥ 209.0</span> -->
    		</div>
    		<div class="submit">
    			<span>应付金额：
    				<font class="total">${totalnum }</font>
    				<a id="confirm" href="confirmSuc.jsp"><img src="images/21_03.png" style="cursor: pointer;" alt="" onclick="#"></img></a>
    			</span>
    		</div>
    	</div>
