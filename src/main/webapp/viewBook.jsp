...
<link rel="stylesheet" href="http://at.alicdn.com/t/font_1368649_u8tq75swzoi.css" />
            ...
            <div class="cn5_top_y center01">
            	<div id="demo" class="cn5topy_1">
                	<div id="small-box" class="cn5topy_imgview">
                    	...
                    	<img src="images/book_view/${book.image }"/>
                ...
                <div class="cn5topy_2">
                    ...
                    <form action="AddShopCarServlet" id="search_form">
                    <div class="pro_buy">
                        ...
                        <div class="pro_addshop"> 
                        	<a href="javascript:document:search_form.submit();">加入购物车 </a>
							<img id="icon-shoucang"></img>
                ...
                <!--内容-->
              	<div class="c5_b2_right_1 box">
                    ...
                    <div class="intro_pics">
                    	<img class="intro_pic" src="images/book_view/${book.image }">
                    </div>
                </div>
