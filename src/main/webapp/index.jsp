...
<body>
		...
		<div class="top_center">
			...
			<ul class="top_bars">
				...
				<ul class="top_lr">
						...
						<li>欢迎登录<a href="#" style="color: red;">${customer.username }</a></li>
					
				</ul>
			
			
				<li><a href="ShowOrdersServlet">我的订单<span
	...
	<div class="header3">
		...
		<div class="h3_right">
				...
				<div class="tsc">
					<a href="shopCartServlet">去购物车结算</a> <span class="sj_right"> </span>
				</div>
		...
		<div class="nav_top_center">
			...
			<ul>
				<c:forEach items="${categories }" var="cat" >
				 <li><a href="#" style="color: red;">${cat.name }</a></li>
				</c:forEach>
		...
		<div class="c3_b1">
				...
				<dl>
					<c:forEach items="${categories }" var="ca">
						<dd>
							<h1>${ca.name }</h1>
							<p>
								<c:forEach items="${ca.cates }" var="cate">
									<a href="#">${cate.name }</a>
								</c:forEach>
							</p>
						</dd>
			...
			<div class="c3_b1_center">
				...
				<div class="c3_b1_c_bottom">
					<ul>
						<li><a href="viewBook.html"><img src="images/index/index_bottom1.jpg" /></a>
							<a href="viewBook.html">区块链开发指南</a></li>
						<li><a href="viewBook.html"><img src="images/index/index_bottom2.jpg" /></a>
							<a href="viewBook.html">Python程序设计</a></li>
						<li><a href="viewBook.html"><img src="images/index/index_bottom3.jpg" /></a>
							<a href="viewBook.html">Java从入门到精通</a></li>
					</ul>
				</div>
			</div>
		...
		<div class="c3_b2">
			<ul>
				<c:forEach items="${books }" var="books">
					<li>
						<div class="c3_b2_txt">
							<a href="viewBookServlet?id=${books.id }">
							<img alt="${books.name }" src="images/book_index/${books.image }">
							<h1>${books.name }</h1>
							<h2>分类:${books.category.name }</h2>
							<h2>价格:${books.price }</h2>
							<h2>畅销书籍</h2>
							<h2>覆盖java基础及全新内容</h2>
							<p>
									<a href="#">更多精彩，点击进入</a>
